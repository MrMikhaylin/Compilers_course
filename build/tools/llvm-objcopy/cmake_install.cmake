# Install script for directory: /home/konstantin/Compilers_course.Task1/llvm-project/llvm/tools/llvm-objcopy
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-objcopy" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/konstantin/Compilers_course.Task1/build/bin/llvm-objcopy")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-objcopy" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-objcopy")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-objcopy"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-extract-bundle-entry" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/home/konstantin/Compilers_course.Task1/llvm-project/llvm/cmake/modules/LLVMInstallSymlink.cmake")
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-extract-bundle-entry" OR NOT CMAKE_INSTALL_COMPONENT)
  install_symlink("llvm-extract-bundle-entry" "llvm-objcopy" "bin" "create_symlink")
endif()
